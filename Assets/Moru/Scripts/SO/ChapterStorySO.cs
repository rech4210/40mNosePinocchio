...
{
    [SerializeField, ReadOnly, LabelText("°ÔÀÓ ÀÎµ¦½º")] private GAME_INDEX myIndex;
    [SerializeField, LabelText("Ã©ÅÍ ÀÌ¸§")] private string chapterName;
    [SerializeField, LabelText("Ã©ÅÍ °£´Ü½ºÅä¸®")] private string chapterDesc;
    [SerializeField, LabelText("Ã©ÅÍ ÀÌ¹ÌÁö")] private Sprite backGround;
